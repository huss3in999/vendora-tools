...
function buildHandover(details, lang) {
  ...
  const phone = cleanText3(envDefaultWhatsapp(), 20) || DEFAULT_WHATSAPP_NUMBER;
  return {
...
function envDefaultWhatsapp() {
  return DEFAULT_WHATSAPP_NUMBER;
}
__name(envDefaultWhatsapp, "envDefaultWhatsapp");
...
// .wrangler/tmp/bundle-dy3z5z/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-dy3z5z/middleware-loader.entry.ts
