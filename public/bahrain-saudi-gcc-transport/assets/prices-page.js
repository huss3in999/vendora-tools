(function () {
  ...
  function render(routes, settings) {
    ...
    list.innerHTML = active.map((r) => {
      ...
      const message = lang === 'en' ? `Hello, I would like to check availability for ${name}.` : `مرحباً، أود التحقق من توفر خدمة ${name}.`;
