(function () {
  ...
  translations.push(
    ...
    ["نقل الركاب","Passenger transport"],
    ["توصيل الطرود","Parcel delivery"],
    ["وجهات الخليج","GCC routes"],
    ["تواصل معنا","Contact us"],
    ["من نحن","About us"],
    ["اطلب عرض سعر للمسار","Request a route quotation"],
    ["هذه الرحلة متاحة بعد مراجعة التشغيل فقط. يعتمد التأكيد على توفر السائق والمركبة ومتطلبات الحدود والوثائق وعرض السعر النهائي.","This journey is available only after operational review. Confirmation depends on driver and vehicle availability, border and document requirements, and the final quotation."],
    ["نرسل للعميل بيانات السائق والمركبة المعينة قبل موعد الاستلام.","The customer receives the assigned driver and vehicle details before pickup."],
    ["خطة الطريق والاستلام","Road and pickup plan"],
    ["تفاصيل عملية قبل الرحلة","Practical details before travel"],
    ["مدن ومواقع الاستلام","Pickup cities and locations"],
    ["مدن ومواقع الوصول","Destination cities and locations"],
    ["المطارات ذات الصلة","Relevant airports"],
    ["المركبة والأمتعة","Vehicle and luggage"],
    ["تُختار فئة المركبة بعد معرفة عدد الركاب والحقائب. تتوفر مقاعد الأطفال عند طلبها مسبقاً وحسب التوفر، ولا نعد بموديل ثابت.","The vehicle category is selected after passenger and luggage details are known. Child seats can be requested in advance, subject to availability; no fixed model is promised."],
    ["الذهاب والعودة والانتظار","One-way, return and waiting"],
    ["يمكن طلب اتجاه واحد أو عودة أو انتظار أو أكثر من توقف. تُراجع التفاصيل والتكلفة والتوفر قبل التأكيد.","One-way, return, waiting and multiple-stop requests can be reviewed. Details, cost and availability are confirmed before booking."],
    ["الوثائق والحدود","Documents and borders"],
    ["يتحمل كل مسافر مسؤولية صلاحية جواز السفر والتأشيرة وتصاريح الدخول وأي وثائق مطلوبة. لا تعني الموافقة على الطلب ضمان الدخول عبر الحدود.","Each passenger is responsible for valid passports, visas, entry permissions and any required documents. Acceptance of a request does not guarantee border entry."],
    ["الاستلام والالتقاء","Pickup and meeting"],
    ["بعد التأكيد نرسل اسم السائق ووسيلة التواصل وبيانات المركبة ونقطة الالتقاء قبل الاستلام. يجب مشاركة رقم الرحلة عند طلب استقبال المطار.","After confirmation, we send the driver name, contact details, assigned vehicle and meeting point before pickup. Flight details are required for airport collections."],
    ["روابط المسار","Route links"],
    ["المسار العكسي","Reverse route"],
    ["مسارات من دولة الانطلاق","Routes from the origin country"],
    ["مسارات من دولة الوصول","Routes from the destination country"],
    ["الأسعار وعروض السعر","Prices and quotations"],
    ...
    ["لا. نؤكد الرحلة بعد مراجعة التشغيل وتوفر السائق والمركبة والوثائق وعرض السعر النهائي.","No. We confirm only after operational review, driver and vehicle availability, document checks and the final quotation."],
    ["هل يمكن ترتيب استقبال من المطار أو رحلة عودة؟","Can I request an airport pickup or return trip?"],
    ["نعم، يمكن طلب استقبال المطار أو العودة أو الانتظار أو التوقفات المتعددة، وتُدرج التفاصيل في عرض السعر.","Yes. Airport pickup, return, waiting and multiple stops can be requested and are included in the quotation review."],
    ...
    ["لا توجد مسارات عامة نشطة حالياً.","There are currently no active public routes."],
    ["عرض تفاصيل المسار","View route details"],
    ["البحرين","Bahrain"],
    ["المنامة","Manama"],
    ["السيف","Seef"],
    ["الجفير","Juffair"],
    ["المحرق","Muharraq"],
    ["سار","Saar"],
    ["فنادق ومنازل البحرين","Bahrain hotels and residential addresses"],
    ["مطار البحرين الدولي","Bahrain International Airport"],
    ["السعودية","Saudi Arabia"],
    ["الخبر","Khobar"],
    ["الدمام","Dammam"],
    ["الرياض","Riyadh"],
    ...
    ["قطر","Qatar"],
    ["الدوحة","Doha"],
    ["فنادق ومنازل قطر","Qatar hotels and residential addresses"],
    ["مطار حمد الدولي","Hamad International Airport"],
    ["الكويت","Kuwait"],
    ["مدينة الكويت","Kuwait City"],
    ["العبدلي","Abdali"],
    ["فنادق ومنازل الكويت","Kuwait hotels and residential addresses"],
    ["مطار الكويت الدولي","Kuwait International Airport"],
    ["الإمارات","UAE"],
    ["دبي","Dubai"],
    ["أبوظبي","Abu Dhabi"],
    ["فنادق ومنازل الإمارات","UAE hotels and residential addresses"],
    ["مطار دبي الدولي","Dubai International Airport"],
    ["مطار زايد الدولي","Zayed International Airport"],
    ["عُمان","Oman"],
    ["مسقط","Muscat"],
    ["فنادق ومنازل عُمان","Oman hotels and residential addresses"],
    ["مطار مسقط الدولي","Muscat International Airport"],
    ["العراق","Iraq"],
    ["البصرة","Basra"],
    ["بغداد","Baghdad"],
    ["كربلاء","Karbala"],
    ...
    ["مطار النجف الدولي","Al Najaf International Airport"],
    ["توصيل من السعودية إلى قطر","Saudi Arabia to Qatar private transport"],
    ["يمكن تنسيق الاستلام من الرياض أو الدمام أو الخبر أو الجبيل أو الأحساء. تُراجع خطة التشغيل من مدينة الاستلام باتجاه الحدود السعودية القطرية ثم إلى الدوحة أو عنوان آخر مؤكد داخل قطر.","Pickup can be coordinated in Riyadh, Dammam, Khobar, Jubail or Al Ahsa. The operating plan is checked from the pickup city toward the Saudi–Qatar border and onward to Doha or another confirmed Qatar address."],
    ["تحتاج نقاط الاستلام من الرياض والمنطقة الشرقية إلى تخطيط مختلف للانطلاق، لذلك يُجهز عرض السعر بعد معرفة موقع الاستلام ووجهة الوصول المطلوبة في الدوحة.","Riyadh and Eastern Province pickups need different departure planning, so the quotation is prepared after the exact pickup point and requested Doha arrival are known."],
    ["توصيل من السعودية إلى قطر بسيارة مع سائق","Saudi Arabia to Qatar Private Transport & Driver"],
    ["اطلب عرض سعر لنقل خاص من السعودية إلى قطر مع تنسيق الاستلام والحدود والسائق والمركبة قبل الرحلة.","Request a private transport quotation from Saudi Arabia to Qatar, with pickup, border process, driver and vehicle coordinated before travel."],
    ["مرحباً فندورا، أريد عرض سعر لنقل خاص من السعودية إلى قطر. موقع الاستلام: ___، الوجهة: ___، التاريخ والوقت: ___، عدد الركاب والحقائب: ___.","Hello Vendora, I need a private transport quotation from Saudi Arabia to Qatar. Pickup: ___, destination: ___, date and time: ___, passengers and luggage: ___."],
    ["توصيل من قطر إلى السعودية","Qatar to Saudi Arabia private transport"],
    ["يلتقي السائق بالراكب في عنوان مؤكد داخل الدوحة أو في مطار حمد الدولي، ثم يتبع خطة الحدود القطرية السعودية المعتمدة باتجاه الأحساء أو الخبر أو الدمام أو الرياض أو وجهة سعودية مؤكدة أخرى.","The driver meets the passenger at a confirmed Doha address or Hamad International Airport, then follows the approved Qatar–Saudi border plan toward Al Ahsa, Khobar, Dammam, Riyadh or another confirmed Saudi destination."],
    ["يُنسق الاستلام من المطار وفق وقت الهبوط الفعلي واستلام الأمتعة، وتدخل فترات الانتظار والتوقفات اللاحقة ضمن مراجعة عرض السعر.","Airport collections are coordinated against the actual landing and baggage collection details; waiting and onward stops are included in the quotation review."],
    ["توصيل من قطر إلى السعودية بسيارة مع سائق","Qatar to Saudi Arabia Private Transport & Driver"],
    ["اطلب عرض سعر لنقل خاص من قطر إلى السعودية مع تنسيق الاستلام والحدود والسائق والمركبة قبل الرحلة.","Request a private transport quotation from Qatar to Saudi Arabia, with pickup, border process, driver and vehicle coordinated before travel."],
    ["مرحباً فندورا، أريد عرض سعر لنقل خاص من قطر إلى السعودية. موقع الاستلام: ___، الوجهة: ___، التاريخ والوقت: ___، عدد الركاب والحقائب: ___.","Hello Vendora, I need a private transport quotation from Qatar to Saudi Arabia. Pickup: ___, destination: ___, date and time: ___, passengers and luggage: ___."],
    ["توصيل من السعودية إلى الإمارات","Saudi Arabia to UAE private transport"],
    ["تُبنى خطة التشغيل بحسب مدينة الاستلام في السعودية والوجهة المختارة داخل الإمارات. وتُراجع انطلاقات الرياض والمنطقة الشرقية كلٌ على حدة قبل التوجه إلى أبوظبي أو دبي أو إمارة أخرى مؤكدة.","The operating plan is built around the Saudi pickup city and the selected UAE destination. Riyadh and Eastern Province departures are reviewed separately before routing toward Abu Dhabi, Dubai or another confirmed emirate."],
    ["تُتفق المقاطع الطويلة بين المدن والاستراحات والعنوان النهائي داخل الإمارات قبل التعيين حتى تناسب فئة المركبة عدد الركاب والأمتعة.","Longer intercity sectors, rest stops and the final UAE address are agreed before assignment so the vehicle category can match passengers and luggage."],
    ["توصيل من السعودية إلى الإمارات بسيارة مع سائق","Saudi Arabia to UAE Private Transport & Driver"],
    ["اطلب عرض سعر لنقل خاص من السعودية إلى الإمارات مع تنسيق الاستلام والحدود والسائق والمركبة قبل الرحلة.","Request a private transport quotation from Saudi Arabia to UAE, with pickup, border process, driver and vehicle coordinated before travel."],
    ["مرحباً فندورا، أريد عرض سعر لنقل خاص من السعودية إلى الإمارات. موقع الاستلام: ___، الوجهة: ___، التاريخ والوقت: ___، عدد الركاب والحقائب: ___.","Hello Vendora, I need a private transport quotation from Saudi Arabia to UAE. Pickup: ___, destination: ___, date and time: ___, passengers and luggage: ___."],
    ["توصيل من الإمارات إلى السعودية","UAE to Saudi Arabia private transport"],
    ["يمكن ترتيب الاستلام من دبي أو أبوظبي أو موقع إماراتي معتمد آخر. ويُراجع المسار باتجاه المنفذ الإماراتي السعودي المناسب ثم إلى المدينة السعودية المطلوبة مثل الرياض أو الدمام أو الخبر.","Pickup may be arranged in Dubai, Abu Dhabi or another approved UAE location. The route is reviewed toward the applicable UAE–Saudi crossing and then the requested Saudi city, such as Riyadh, Dammam or Khobar."],
    ["تؤثر إمارة الاستلام مباشرة في خطة التشغيل. ويجب مشاركة وقت وصول الرحلة أو مغادرة الفندق وجاهزية وثائق الحدود قبل إعداد عرض السعر.","The pickup emirate materially affects the operating plan. Flight arrival, hotel checkout and border-document readiness should be shared before quotation."],
    ["توصيل من الإمارات إلى السعودية بسيارة مع سائق","UAE to Saudi Arabia Private Transport & Driver"],
    ["اطلب عرض سعر لنقل خاص من الإمارات إلى السعودية مع تنسيق الاستلام والحدود والسائق والمركبة قبل الرحلة.","Request a private transport quotation from UAE to Saudi Arabia, with pickup, border process, driver and vehicle coordinated before travel."],
    ["مرحباً فندورا، أريد عرض سعر لنقل خاص من الإمارات إلى السعودية. موقع الاستلام: ___، الوجهة: ___، التاريخ والوقت: ___، عدد الركاب والحقائب: ___.","Hello Vendora, I need a private transport quotation from UAE to Saudi Arabia. Pickup: ___, destination: ___, date and time: ___, passengers and luggage: ___."],
    ["توصيل من الإمارات إلى البحرين","UAE to Bahrain private transport"],
    ["تُخطط الرحلة من عنوان الاستلام المؤكد في دبي أو أبوظبي أو داخل الإمارات عبر تسلسل العبور السعودي المراجع وجسر الملك فهد وصولاً إلى العنوان النهائي في البحرين.","The journey is planned from the confirmed Dubai, Abu Dhabi or UAE pickup address through the reviewed Saudi transit sequence and King Fahd Causeway toward the final Bahrain address."],
    ["لأن الرحلة تمر بأكثر من إجراء حدودي، تُراجع وثائق الركاب وأهلية المركبة والتوقفات المخططة ونقطة الوصول النهائية في البحرين قبل التأكيد.","Because the journey crosses more than one border process, passenger documents, vehicle eligibility, planned stops and final Bahrain meeting point are checked before confirmation."],
    ["توصيل من الإمارات إلى البحرين بسيارة مع سائق","UAE to Bahrain Private Transport & Driver"],
    ["اطلب عرض سعر لنقل خاص من الإمارات إلى البحرين مع تنسيق الاستلام والحدود والسائق والمركبة قبل الرحلة.","Request a private transport quotation from UAE to Bahrain, with pickup, border process, driver and vehicle coordinated before travel."],
    ["مرحباً فندورا، أريد عرض سعر لنقل خاص من الإمارات إلى البحرين. موقع الاستلام: ___، الوجهة: ___، التاريخ والوقت: ___، عدد الركاب والحقائب: ___.","Hello Vendora, I need a private transport quotation from UAE to Bahrain. Pickup: ___, destination: ___, date and time: ___, passengers and luggage: ___."],
    ["توصيل من البحرين إلى الإمارات","Bahrain to UAE private transport"],
    ["يُنسق الاستلام من منزل أو فندق أو مقر عمل في البحرين أو من مطار البحرين الدولي، ثم تستمر الخطة المراجعة عبر جسر الملك فهد والعبور في السعودية باتجاه أبوظبي أو دبي أو عنوان إماراتي مؤكد آخر.","Pickup is coordinated from a Bahrain home, hotel, office or Bahrain International Airport, then the reviewed plan continues through King Fahd Causeway and Saudi transit toward Abu Dhabi, Dubai or another confirmed UAE address."],
    ["يختلف المقطع الأخير بين دبي وأبوظبي. وتُستخدم الوجهة ونافذة الوصول المطلوبة وحجم الأمتعة لإعداد عرض السعر النهائي والتعيين.","Dubai and Abu Dhabi have different final sectors. The destination, requested arrival window and luggage load are used to prepare the final quotation and assignment."],
    ["توصيل من البحرين إلى الإمارات بسيارة مع سائق","Bahrain to UAE Private Transport & Driver"],
    ["اطلب عرض سعر لنقل خاص من البحرين إلى الإمارات مع تنسيق الاستلام والحدود والسائق والمركبة قبل الرحلة.","Request a private transport quotation from Bahrain to UAE, with pickup, border process, driver and vehicle coordinated before travel."],
    ["مرحباً فندورا، أريد عرض سعر لنقل خاص من البحرين إلى الإمارات. موقع الاستلام: ___، الوجهة: ___، التاريخ والوقت: ___، عدد الركاب والحقائب: ___.","Hello Vendora, I need a private transport quotation from Bahrain to UAE. Pickup: ___, destination: ___, date and time: ___, passengers and luggage: ___."],
    ["توصيل من قطر إلى الإمارات","Qatar to UAE private transport"],
    ["يُرتب الاستلام من الدوحة أو مطار حمد الدولي. وتُراجع خطة الطريق عبر إجراءات قطر والسعودية والعبور داخل السعودية ومنفذ الدخول المناسب إلى الإمارات قبل المتابعة إلى أبوظبي أو دبي.","Pickup is arranged in Doha or at Hamad International Airport. The road plan is reviewed through the Qatar–Saudi process, Saudi transit and the applicable UAE entry point before continuing to Abu Dhabi or Dubai."],
    ["يتطلب تسلسل العبور بين الدول مراجعة مبكرة للوثائق. ويُثبت عرض السعر انتظار المطار والاستراحات والمدينة المختارة داخل الإمارات.","The multi-country sequence requires early document review. Airport waiting, rest stops and the selected UAE city are confirmed in the quotation."],
    ["توصيل من قطر إلى الإمارات بسيارة مع سائق","Qatar to UAE Private Transport & Driver"],
    ["اطلب عرض سعر لنقل خاص من قطر إلى الإمارات مع تنسيق الاستلام والحدود والسائق والمركبة قبل الرحلة.","Request a private transport quotation from Qatar to UAE, with pickup, border process, driver and vehicle coordinated before travel."],
    ["مرحباً فندورا، أريد عرض سعر لنقل خاص من قطر إلى الإمارات. موقع الاستلام: ___، الوجهة: ___، التاريخ والوقت: ___، عدد الركاب والحقائب: ___.","Hello Vendora, I need a private transport quotation from Qatar to UAE. Pickup: ___, destination: ___, date and time: ___, passengers and luggage: ___."],
    ["توصيل من الإمارات إلى قطر","UAE to Qatar private transport"],
    ["تُعيّن المركبة بالقرب من منطقة الاستلام المؤكدة داخل الإمارات، ثم يراجع فريق التشغيل إجراءات الإمارات والسعودية والعبور داخل السعودية والدخول إلى قطر قبل التوصيل النهائي في الدوحة أو قطر.","The vehicle is assigned near the confirmed UAE pickup area, then the operating team reviews the UAE–Saudi process, Saudi transit and Qatar entry before the final Doha or Qatar drop-off."],
    ["تحتاج انطلاقات دبي وأبوظبي إلى توقيت استلام مختلف. يجب مشاركة بيانات الرحلة أو الفندق أو العنوان السكني وجميع التوقفات قبل التأكيد.","Dubai and Abu Dhabi departures require separate pickup timing. Share the flight, hotel or residential address and all planned stops before confirmation."],
    ["توصيل من الإمارات إلى قطر بسيارة مع سائق","UAE to Qatar Private Transport & Driver"],
    ["اطلب عرض سعر لنقل خاص من الإمارات إلى قطر مع تنسيق الاستلام والحدود والسائق والمركبة قبل الرحلة.","Request a private transport quotation from UAE to Qatar, with pickup, border process, driver and vehicle coordinated before travel."],
    ["مرحباً فندورا، أريد عرض سعر لنقل خاص من الإمارات إلى قطر. موقع الاستلام: ___، الوجهة: ___، التاريخ والوقت: ___، عدد الركاب والحقائب: ___.","Hello Vendora, I need a private transport quotation from UAE to Qatar. Pickup: ___, destination: ___, date and time: ___, passengers and luggage: ___."],
    ["توصيل من الكويت إلى البحرين","Kuwait to Bahrain private transport"],
    ["يمكن تنسيق الاستلام من مدينة الكويت أو العبدلي أو مطار الكويت الدولي أو عنوان معتمد آخر، ثم اتباع إجراءات الكويت والسعودية المراجعة والعبور داخل السعودية وجسر الملك فهد إلى البحرين.","Pickup can be coordinated in Kuwait City, Abdali, Kuwait International Airport or another approved address, followed by the reviewed Kuwait–Saudi process, Saudi transit and King Fahd Causeway into Bahrain."],
    ["يشمل المسار مقطع عبور داخل السعودية. وتُراجع وثائق دخول الركاب وحجم الأمتعة والتوقفات والعنوان النهائي في البحرين قبل التعيين.","The route includes a Saudi transit sector. All passenger entry documents, luggage volume, stops and the final Bahrain address are reviewed before assignment."],
    ["توصيل من الكويت إلى البحرين بسيارة مع سائق","Kuwait to Bahrain Private Transport & Driver"],
    ["اطلب عرض سعر لنقل خاص من الكويت إلى البحرين مع تنسيق الاستلام والحدود والسائق والمركبة قبل الرحلة.","Request a private transport quotation from Kuwait to Bahrain, with pickup, border process, driver and vehicle coordinated before travel."],
    ["مرحباً فندورا، أريد عرض سعر لنقل خاص من الكويت إلى البحرين. موقع الاستلام: ___، الوجهة: ___، التاريخ والوقت: ___، عدد الركاب والحقائب: ___.","Hello Vendora, I need a private transport quotation from Kuwait to Bahrain. Pickup: ___, destination: ___, date and time: ___, passengers and luggage: ___."],
    ["توصيل من عُمان إلى البحرين","Oman to Bahrain private transport"],
    ["يُنسق الاستلام من مسقط أو مطار مسقط الدولي أو عنوان معتمد آخر في عُمان. ويُراجع تسلسل التشغيل عبر إجراءات عُمان والإمارات المناسبة والعبور في الإمارات والسعودية وجسر الملك فهد إلى البحرين.","Pickup is coordinated in Muscat, at Muscat International Airport or another approved Oman address. The operating sequence is reviewed through the applicable Oman–UAE process, UAE and Saudi transit, and King Fahd Causeway into Bahrain."],
    ["هذه رحلة طويلة تمر بعدة دول. ويجب تأكيد خطة الاستراحات وترتيبات السائق والأمتعة والجاهزية الحدودية ونقطة الوصول في البحرين مسبقاً.","This is a long multi-country journey. Rest planning, driver arrangements, luggage, border readiness and the Bahrain arrival point must all be confirmed in advance."],
    ["توصيل من عُمان إلى البحرين بسيارة مع سائق","Oman to Bahrain Private Transport & Driver"],
    ["اطلب عرض سعر لنقل خاص من عُمان إلى البحرين مع تنسيق الاستلام والحدود والسائق والمركبة قبل الرحلة.","Request a private transport quotation from Oman to Bahrain, with pickup, border process, driver and vehicle coordinated before travel."],
    ["مرحباً فندورا، أريد عرض سعر لنقل خاص من عُمان إلى البحرين. موقع الاستلام: ___، الوجهة: ___، التاريخ والوقت: ___، عدد الركاب والحقائب: ___.","Hello Vendora, I need a private transport quotation from Oman to Bahrain. Pickup: ___, destination: ___, date and time: ___, passengers and luggage: ___."],
    ["نقل خاص من السعودية إلى دول الخليج","Private transport from Saudi Arabia across the GCC"],
    ["المسارات النشطة فقط من السعودية. كل طلب يخضع للتوفر والمراجعة التشغيلية ومتطلبات الحدود والوثائق وعرض السعر النهائي.","Only active routes from Saudi Arabia are shown. Every request remains subject to availability, operational review, border and document requirements, and a final quotation."],
    ["نقل خاص من قطر إلى دول الخليج","Private transport from Qatar across the GCC"],
    ["المسارات النشطة فقط من قطر. كل طلب يخضع للتوفر والمراجعة التشغيلية ومتطلبات الحدود والوثائق وعرض السعر النهائي.","Only active routes from Qatar are shown. Every request remains subject to availability, operational review, border and document requirements, and a final quotation."],
    ["نقل خاص من الإمارات إلى دول الخليج","Private transport from UAE across the GCC"],
    ["المسارات النشطة فقط من الإمارات. كل طلب يخضع للتوفر والمراجعة التشغيلية ومتطلبات الحدود والوثائق وعرض السعر النهائي.","Only active routes from UAE are shown. Every request remains subject to availability, operational review, border and document requirements, and a final quotation."],
    ["نقل خاص من البحرين إلى دول الخليج","Private transport from Bahrain across the GCC"],
    ["المسارات النشطة فقط من البحرين. كل طلب يخضع للتوفر والمراجعة التشغيلية ومتطلبات الحدود والوثائق وعرض السعر النهائي.","Only active routes from Bahrain are shown. Every request remains subject to availability, operational review, border and document requirements, and a final quotation."],
