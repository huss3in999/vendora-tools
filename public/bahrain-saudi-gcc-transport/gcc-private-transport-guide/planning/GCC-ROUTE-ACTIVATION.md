...
- `config/gcc-countries.json`: country names, country hubs, pickup areas and airports.
- `config/gcc-routes.json`: all 42 directional country routes and their operational/publication gates.
- `config/chauffeur-services.json`: chauffeur-service hub and service visibility.
- `config/route-prices.json`: the only source for public numeric route pricing.
- `config/business-config.json`: the only source for public business and contact information.
...
6. Edit the `SA-QA` record in `config/gcc-routes.json`:
...
9. Review both generated files:

```text
gcc-private-transport-guide/planning/private-preview/ar/routes/saudi-to-qatar/index.html
gcc-private-transport-guide/planning/private-preview/en/routes/saudi-to-qatar/index.html
```
...
```text
gcc-private-transport-guide/planning/private-preview/
```
