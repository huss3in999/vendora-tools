...
async function mockAdmin(page, googleResponse = null) {
  await page.route('https://getvendora.net/**/api/transport/admin**', async (route) => {
    ...
    else if (resource === 'summary') body.summary = { total_visitors: 2, total_sessions: 3, total_pageviews: 4, whatsapp_intents_count: 1, whatsapp_cancelled_count: 1, whatsapp_departed_count: 1, left_without_whatsapp: 1 };
